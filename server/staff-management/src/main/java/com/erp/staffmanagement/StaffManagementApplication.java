...
public class StaffManagementApplication {
  ...
  public void started() {
    ...
    String dependentDocumentDirPath = "docs/staff/attachedFile/dependentDocuments";
    ...
    String certificateDocumentDirPath = "docs/staff/attachedFile/certificateDocuments";
