...
public class HttpUtils {
    ...
    private static String parseBrowser(String agent) {
        if (agent.contains("trident/7.0")) return "IE11";
        if (agent.contains("msie 10")) return "IE10";
        if (agent.contains("msie 9")) return "IE9";
        if (agent.contains("msie 8")) return "IE8";
        if (agent.contains("edg")) return "Edge";
        if (agent.contains("chrome")) return "Chrome";
        if (!agent.contains("chrome") && agent.contains("safari")) return "Safari";
